...
export function StickyCTA({ price, listingTitle, sold, triggerRef }: Props) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
          ...
          {sold ? (
            ...
            <div className="flex gap-2 shrink-0">
              <Link
                href="/messages"
                className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-semibold text-sm rounded-xl transition-colors active:scale-95"
              >
                Contact Seller
              </Link>
            </div>
