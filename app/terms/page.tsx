...
export const metadata: Metadata = {
  title: "Terms of Service | TriniSell",
  description: "Read TriniSell's Terms of Service — the rules and guidelines for buying and selling on Trinidad & Tobago's local marketplace.",
};
  ...
  const sections = [
    {
      ...
      body: "By accessing or using TriniSell you agree to be bound by these Terms of Service and all applicable laws. If you do not agree, do not use the platform.",
    },
    {
      title: "2. Who Can Use TriniSell",
    ...
    },
    {
      ...
      body: "You are solely responsible for listings and content you post. You must not post illegal items, stolen goods, counterfeit products, or anything that violates Trinidad & Tobago law. TriniSell reserves the right to remove any listing at any time without notice.",
    },
    {
      title: "4. Transactions",
      body: "TriniSell is a marketplace platform and is not a party to any transaction between buyers and sellers. We do not guarantee the quality, safety, or legality of items listed. Always meet in a safe public place and inspect items before payment.",
    },
    {
    ...
    },
    {
      ...
      body: "Listing boosts are one-time payments per listing, processed via WiPay. Business Storefront subscriptions are billed monthly and may be cancelled at any time from your Dashboard. Cancellation takes effect at the end of the current billing period. Refunds are not provided for partially used periods.",
    },
    {
      title: "7. Intellectual Property",
      body: "All content, design, and code on TriniSell is owned by TriniSell or its licensors. You may not reproduce or distribute any part of the platform without prior written consent.",
    },
    {
      title: "8. Limitation of Liability",
      body: 'TriniSell is provided "as is" without warranties of any kind. We are not liable for any direct, indirect, incidental, or consequential damages arising from your use of the platform or any transaction conducted through it.',
    },
    {
