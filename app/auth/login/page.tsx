      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Sign in to your TriniMarket account</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <Button type="submit" fullWidth size="lg" className="mt-2">Sign in</Button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/signup" className="text-blue-700 font-medium hover:text-blue-800 transition-colors">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
